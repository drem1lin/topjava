...
public class MealsUtil {
    ...
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(SecurityUtil.authUserId() + 2, LocalDateTime.of(2020, Month.JANUARY, 31, 13, 0), "Обед", 500),
            new Meal(SecurityUtil.authUserId() + 2, LocalDateTime.of(2020, Month.JANUARY, 31, 20, 0), "Ужин", 410)
    );
